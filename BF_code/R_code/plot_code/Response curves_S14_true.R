...
model <- glm(NPP_S ~  H_mean + H_D +TMP_slope + Pre_slope + TMP_mean + PRE_mean + FIRE_slope + POP_slope + FIRE_mean + POP_mean, data = data)
summary(model)

# 预测值及其置信区间
predictions <- predict(model, interval = "confidence", level = 0.95)
predicted_df <- as.data.frame(predictions)
predicted_data <- cbind(predicted_df, data[c("H_D", "H_mean", "TMP_slope", "Pre_slope", "TMP_mean", "PRE_mean", "FIRE_slope", "POP_slope", "FIRE_mean", "POP_mean")])
cor(predicted_data)
head(predicted_data)
...
# H_slope <- ggplot(data, aes(x = H_slope, y = NPP_S)) +
#   #geom_point()+
...
H_D <- ggplot(data, aes(x = H_D, y = NPP_S)) +
  #geom_point()+
  geom_smooth(method = "glm",  color="black",  se= TRUE, fill = "#36ACA2", size = 1.5) +
  ylim(-1, 2) + xlim(-0.25, 0.5) +
  theme_linedraw(base_size = 40)+
  theme(text = element_text(size = 30), axis.text = element_blank(),
        axis.title.y = element_blank(), axis.title.x = element_blank(),
        panel.grid.minor = element_blank(),
...
H_mean <- ggplot(data, aes(x = H_mean, y = NPP_S)) +
  #geom_point()+
  geom_smooth(method = "glm",  color="black",  se= TRUE, fill = "#36ACA2", size = 1.5) +
...
TMP_mean <- ggplot(data, aes(x = TMP_mean, y = NPP_S)) +
  #geom_point()+
  geom_smooth(method = "glm",  color="black",  se= TRUE, fill = "#36ACA2", size = 1.5) +
  ylim(-1, 2) + xlim(3, 17) +
  theme_linedraw(base_size = 40)+
...
PRE_mean <- ggplot(data, aes(x = PRE_mean, y = NPP_S)) +
  #geom_point()+
  geom_smooth(method = "glm",  color="black",  se= TRUE, fill = "#36ACA2", size = 1.5) +
  ylim(-1, 2) + xlim(1, 5) +
  theme_linedraw(base_size = 40)+
...
TMP_slope <- ggplot(data, aes(x = TMP_slope, y = NPP_S)) +
  #geom_point()+
  geom_smooth(method = "glm",  color="black",  se= TRUE, fill = "#36ACA2", size = 1.5) +
  ylim(-1, 2) + xlim(0, 0.1) +
  theme_linedraw(base_size = 40)+
...
Pre_slope <- ggplot(data, aes(x = Pre_slope, y = NPP_S)) +
  #geom_point()+
  geom_smooth(method = "glm",  color="black",  se= TRUE, fill = "#36ACA2", size = 1.5) +
  ylim(-1, 2) + xlim(-5, 5) +
  theme_linedraw(base_size = 40)+
...
plot_NPP_S <- plot_grid(H_D, H_mean, TMP_mean, PRE_mean,TMP_slope, Pre_slope, 
...
model <- glm(kNDVI_S2 ~  H_mean + H_D +TMP_slope + Pre_slope + TMP_mean + PRE_mean + FIRE_slope + POP_slope + FIRE_mean + POP_mean, data = data)
summary(model)
...
H_D <- ggplot(predicted_data, aes(x = H_D, y = predictions)) +
  #geom_point()+
  geom_smooth(method = "glm",  color="black",  se= TRUE, fill = "#36ACA2", size = 1.5) +
  ylim(-0.004, 0.005) + xlim(-0.25, 0.5) +
  theme_linedraw(base_size = 40)+
  theme(text = element_text(size = 30), axis.text = element_blank(),
        axis.title.y = element_blank(), axis.title.x = element_blank(),
        panel.grid.minor = element_blank(),
...
plot_kNDVI <- plot_grid(H_D, H_mean, TMP_mean, PRE_mean,TMP_slope, Pre_slope, 
                        align="hv", label_size = 20, ncol = 6, nrow = 1, label_fontface = "plain")
plot_kNDVI
...
model <- glm(VOD_Ku_S ~  H_mean + H_D +TMP_slope + Pre_slope + TMP_mean + PRE_mean + FIRE_slope + POP_slope + FIRE_mean + POP_mean, data = data)
summary(model)
...
plot_VOD_Ku_S <- plot_grid(H_D, H_mean, TMP_mean, PRE_mean,TMP_slope, Pre_slope, 
                           align="hv", label_size = 20, ncol = 6, nrow = 1, label_fontface = "plain")
plot_VOD_Ku_S
...
model <- glm(Carbon_S ~  H_mean + H_D +TMP_slope + Pre_slope + TMP_mean + PRE_mean + FIRE_slope + POP_slope + FIRE_mean + POP_mean, data = data)
summary(model)
...
plot_Carbon_S <- plot_grid(H_D, H_mean, TMP_mean, PRE_mean,TMP_slope, Pre_slope, 
                           align="hv", label_size = 20, ncol = 6, nrow = 1, label_fontface = "plain")
plot_Carbon_S
...
model <- glm(Biomass_ ~  H_mean + H_D +TMP_slope + Pre_slope + TMP_mean + PRE_mean + FIRE_slope + POP_slope + FIRE_mean + POP_mean, data = data)
summary(model)
...
plot_Biomass_S <- plot_grid(H_D, H_mean, TMP_mean, PRE_mean,TMP_slope, Pre_slope, 
                            align="hv", label_size = 20, ncol = 6, nrow = 1, label_fontface = "plain")
plot_Biomass_S
...
model <- glm(Stabi_S ~  H_mean + H_D +TMP_slope + Pre_slope + TMP_mean + PRE_mean + FIRE_slope + POP_slope + FIRE_mean + POP_mean, data = data)
summary(model)
...
plot_Stabi_S <- plot_grid(H_D, H_mean, TMP_mean, PRE_mean,TMP_slope, Pre_slope, 
                          align="hv", label_size = 20, ncol = 6, nrow = 1, label_fontface = "plain")
plot_Stabi_S
...
ggsave("plot_trend_1126.jpg",device = "jpg",width = 800, height = 800, units = "mm", dpi = 600)
